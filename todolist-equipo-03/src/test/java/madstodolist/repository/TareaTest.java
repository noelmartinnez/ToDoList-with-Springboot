...
public class TareaTest {
    ...
    public void crearTarea() {
        ...
        assertThat(tarea.isDestacada()).isFalse();
    }
    ...
    public void comprobarIgualdadTareasSinId() {
        ...
        assertThat(tarea1.isDestacada()).isEqualTo(tarea2.isDestacada());
    }
    ...
    public void comprobarIgualdadTareasConId() {
        ...
        assertThat(tarea1.isDestacada()).isEqualTo(tarea3.isDestacada());
    }
    ...
    @Test
    @Transactional
    public void guardarTareaEnBaseDatos() throws ParseException {
        // GIVEN
        ...
        assertThat(tareaBD.isDestacada()).isEqualTo(tarea.isDestacada());
        assertThat(tareaBD.getFechaLimite()).isEqualTo(tarea.getFechaLimite());
    }
