...
public class Tarea implements Serializable {
    ...
    // Nuevo atributo para poder destacar o no una determinada tarea.
    ...
    private EstadoTarea estado = EstadoTarea.POR_HACER;


    // Nuevo atributo para poder añadir una fecha límite a una tarea.
    ...
    @ManyToOne
    @JoinColumn(name = "equipo_Asignado_id")
    ...
    // Getter y Setter para el nuevo atributo de fecha límite
